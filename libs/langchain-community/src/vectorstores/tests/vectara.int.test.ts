...
const getDocs = (): Document[] => {
  ...
  const documents = [
    new Document({
      ...
      metadata: {
        document_id: secureHash(englishOne), // Generate a hashcode for document id based on the text
    ...
    new Document({
      ...
      metadata: {
        document_id: secureHash(englishTwo), // Generate a hashcode for document id based on the text
        title: "Lord of the Rings",
        author: "Tolkien",
        genre: "fiction",
        lang: "eng",
    ...
    new Document({
      ...
      metadata: {
        document_id: secureHash(frenchOne), // Generate a hashcode for document id based on the text
